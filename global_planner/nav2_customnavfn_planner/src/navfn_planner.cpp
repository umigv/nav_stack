...
#include "nav2_customnavfn_planner/navfn_planner.hpp"
...
#include "nav2_customnavfn_planner/navfn.hpp"
...
namespace nav2_customnavfn_planner
{
  ...
  std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap_ros)
{
  ...
  RCLCPP_INFO(
    logger_, "HEY WE CAN EDIT THE SOURCE CODE NOW Configuring plugin %s of type NavfnPlanner",
    name_.c_str());
...
PLUGINLIB_EXPORT_CLASS(nav2_customnavfn_planner::NavfnPlanner, nav2_core::GlobalPlanner)